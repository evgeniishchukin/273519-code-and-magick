...
(function () {
  ...
  window.colorize.colorizeElement(setup.querySelector('#wizard-coat'), [
    'rgb(101, 137, 164)',
    'rgb(241, 43, 107)',
    'rgb(146, 100, 161)',
    'rgb(56, 159, 117)',
  ...
  window.colorize.colorizeElement(setup.querySelector('#wizard-eyes'), [
    'black',
    'red',
    'blue',
    'yellow',
  ...
  window.colorize.colorizeElement(setup.querySelector('.setup-fireball-wrap'), [
    '#ee4830',
    '#30a8ee',
    '#5ce6c0',
    '#e848d5',
